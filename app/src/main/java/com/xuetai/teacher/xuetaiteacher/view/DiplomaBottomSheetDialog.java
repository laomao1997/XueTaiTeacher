...
public class DiplomaBottomSheetDialog extends BottomSheetDialogFragment {

    int photoArgs = 0; // 操作参数 1-打开相机 2-打开图库

    private AvatarBottomSheetDialog.ClickListenerInterface clickListenerInterface;
    ...
    public void setClicklistener(AvatarBottomSheetDialog.ClickListenerInterface clickListenerInterface) {
